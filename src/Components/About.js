    ...
    <div className="about-container">
      ...
      <Figure>
        <Figure.Caption>
          ...
          incredible shipping and delivery partners, we have a stellar record of
          delivering your prized instrument to you in the same condition as when
          it first came out of the workshop. Not only this, but we are also the
          forerunners of woodwind instrument repair in the country, so if you
          require these services, do not hesitate to send us a query using the
          email below. We are passionate about sharing knowledge on these
          marvelous instruments, and so our award-winning customer service is
          ready to promptly answer any questions you may have.
        </Figure.Caption>
      </Figure>
